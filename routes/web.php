...
/*
|--------------------------------------------------------------------------
| 2. RUTAS DE VERIFICACIÓN (2FA) - PARA TODOS LOS USUARIOS
|--------------------------------------------------------------------------
| Estas rutas deben estar fuera de los grupos específicos para que 
| Administradores, Docentes y Estudiantes puedan validar su código.
*/
Route::middleware(['auth:estudiante,docente,web'])->group(function () {
...
/*
|--------------------------------------------------------------------------
| 3. PANEL ADMINISTRATIVO (Middleware 'auth' - Administrador)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| 4. PANEL DE DOCENTES (Middleware 'auth:docente')
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| 5. PANEL DE ESTUDIANTES (Middleware 'auth:estudiante')
|--------------------------------------------------------------------------
*/
